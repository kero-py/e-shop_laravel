...
<div class="container">
    ...
    <h1>Stripe - Card payment page <br/> E-shop Laravel - *** FOR TEST PURPOSES ONLY - YOUR PAYMENT WILL NOT BE PROCESSED ***</h1>
...
$(function() {
    ...
    $('form.require-validation').bind('submit', function(e) {
     ...
     /* generates tokens for inputted data (no data is captured to local database) */
